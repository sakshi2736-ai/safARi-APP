      ...
      >
        ...
        <button
          ...
          onClick={() => {
            ...
            link.href = "/safari.apk";
            link.download = "SafARi.apk";
            document.body.appendChild(link);
            link.click();
            document.body.removeChild(link);
          }}
          className="px-8 py-3 rounded-full bg-yellow-500 text-white font-semibold shadow-lg opacity-0 hover:bg-yellow-600 transition-transform duration-300 hover:scale-110 hover:-translate-y-1"
        >
          Download
        </button>
      </div>
