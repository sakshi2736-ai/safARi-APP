...
export default function AppPreview() {
  ...
  return (
    <section className="w-full flex flex-col gap-6 py-10 px-4 sm:px-6">
      ...
      <div className="w-full md:w-[80%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
        ...
        {images.map((img, i) => (
          <div
            ...
            className="cursor-pointer bg-white border border-gray-200 shadow-md rounded-xl p-3 flex items-center justify-center
