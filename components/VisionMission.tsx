...
export default function VisionMission() {
  return (
    <section className="w-full flex flex-col gap-8 md:gap-10 py-12 md:py-16 px-4 md:px-6">
      ...
      <div className="w-full md:w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        ...
        >
          ...
          <div className="bg-white shadow-md rounded-xl p-5 md:p-6 border border-gray-200
                          transition-all duration-300 ease-in-out
                          hover:-translate-y-2 hover:bg-green-50 hover:shadow-xl hover:scale-[1.02]">
